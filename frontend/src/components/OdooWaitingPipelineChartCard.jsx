...
function OdooWaitingPipelineChartCard({ commercialId }) {
  ...
  useEffect(() => {
    ...
    apiFetch(`${API_URL}/api/odoo/waiting-pipeline-daily/${commercialId}?days=7&end=${endStr}`)
      .then((r) => r.json())
      .then((res) => {
        setData(res);
        setLoading(false);
...
export default OdooWaitingPipelineChartCard;